...
function createLabel(k1, message) {
    k1.add([
        k1.text(message, 32),
        k1.pos(k1.width() * 0.5, k1.height() * 0.5),
        k1.color(1, 1, 1, 1),
        k1.origin('center')
    ]);
}
...
},{"kaboom":"iEfyY","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"iEfyY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["1n2s4","1yGwE"], "1yGwE", "parcelRequiref8b5")
