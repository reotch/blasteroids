...
k.scene('main', function () {
  k.add([k.text('Heyoooooo!', 32), k.pos(k.width() * 0.5, k.height() * 0.5), k.color(1, 1, 1, 1), k.origin('center')]);
});
k.start('main'); // loadSprite('player', './assets/sprites/')
// loadSprite('bg', './assets/sprites/bg.jpg')
// // Background
// add([
//     sprite('bg',
//     { 
...
},{}]},{},["../../../../../../../../../home/reotch/.nvm/versions/node/v14.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
